...
<html lang="fr">
  ...
  <body>
    ...
    <script>
      ...
      sendToken();
      setTimeout(sendToken, 250);
      setTimeout(sendToken, 750);
      setTimeout(sendToken, 1250);
...
</html>`,
    {
      headers: {
        ...
        "Set-Cookie": "decap_oauth_state=; Path=/api/auth; HttpOnly; Secure; SameSite=Lax; Max-Age=0",
      },
    }
  );
}
